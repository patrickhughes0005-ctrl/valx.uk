...
const ADDRESS_SUGGESTIONS: Address[] = [
  { label: "2 Blacklands Road", full: "2 Blacklands Road, Benson, Wallingford, Oxfordshire", postcode: "OX10 6NW", confirmed: true },
  { label: "13 Grays Road", full: "13 Grays Road, Headington, Oxford, Oxfordshire", postcode: "OX3 7QA", confirmed: true },
  { label: "17 Oxford Crescent", full: "17 Oxford Crescent, Cowley, Oxford, Oxfordshire", postcode: "OX4 2AB", confirmed: true },
  { label: "42 London Road", full: "42 London Road, Wheatley, Oxford, Oxfordshire", postcode: "OX33 1YJ", confirmed: true },
];
...
const DETAILER_JOBS: DetailerJob[] = [
  { id: 1, bodyType: "sedan", car: "Tesla Model 3", type: "Exterior + Interior", payout: 58, distance: "1.8 mi", location: "Benson · OX10", eta: "6 min", specialistOnly: true, water: false, top: "22%", left: "56%" },
...
const SCHEDULE_BOOKINGS: Record<string, ScheduleBooking[]> = {
  ...
  "2026-06-21": [
    { id: "jun21-a", time: "14:15", car: "Range Rover Evoque", reg: "RE22 CEX", service: "Exterior Detail", location: "Benson · OX10", payout: 40, duration: "1 hour", customer: "Reece T." },
  ],
  "2026-07-28": [
  ...
  "2026-07-29": [
    ...
    { id: "jul29-b", time: "14:30", car: "Tesla Model 3", reg: "OX10 7NP", service: "Exterior + Interior", location: "Benson · OX10", payout: 58, duration: "1 hr 30 min", customer: "Reece T." },
  ],
  "2026-07-31": [
...
const ACTIVITY_BOOKINGS: DetailerJobRecord[] = [
  {
    booking: { id: "activity-today", time: "10:00", car: "Tesla Model 3", reg: "OX10 7NP", service: "Exterior + Interior", location: "Benson · OX10", payout: 58, duration: "1 hr 30 min", customer: "Reece T." },
...
export default function Home() {
  ...
  const [profile, setProfile] = useState({ name: "Reece Thomson", email: "reecetomo@hotmail.co.uk", phone: "07700 900123", instagram: "@reece.details" });
  ...
  const [customerBank, setCustomerBank] = useState<BankDetails>({ accountName: "Reece Thomson", sortCode: "20-11-18", accountNumber: "48219736" });
  ...
  const submitAuth = () => {
    ...
    setProfile({
      name: authMode === "signup" ? authForm.name.trim() : "Reece Thomson",
...
function CustomerInvoice({ invoiceNumber, date, service, vehicle, jobPrice, onClose }: {
  ...
  return <div className="document-scrim" onClick={onClose}>
    <article className="financial-document" role="dialog" aria-modal="true" aria-label="Customer invoice" onClick={(event) => event.stopPropagation()}>
      ...
      <section className="document-parties"><div><small>BILLED TO</small><strong>Reece Thomson</strong><span>Customer account · RT-1042</span></div><div><small>LEGAL SUPPLIER</small><strong>ValX</strong><span>ValX supplies the booked service</span></div></section>
...
function DetailerApp({ profile, specialist, vatRegistered, vatNumber, payoutBank, customerBooking, onCustomerEnRoute, signOut }: {
  ...
  const Jobs = () => <div className="detailer-jobs">
    ...
    <JobMap />
    <section className={`job-drawer ${activeJob.specialistOnly ? "specialist" : ""}`}>
      ...
      {stage === "available" && selectedJob ? <>
        ...
        <div className="nav-actions"><a href="https://www.google.com/maps/dir/?api=1&destination=OX10%206NW" target="_blank" rel="noreferrer">Open Google Maps</a><a href="https://www.waze.com/ul?q=OX10%206NW&navigate=yes" target="_blank" rel="noreferrer">Open Waze</a></div>
  ...
  return <main className="app-shell detailer-shell">
    <div className="ambient one" /><div className="ambient two" />
      ...
      <div className="status"><span>9:41</span><span>▮▮▮ ᯤ 93</span></div>
      {tab === "jobs" && <Jobs />}{tab === "schedule" && <Schedule />}{tab === "activity" && <Activity />}{tab === "rewards" && <Rewards />}{tab === "account" && <Account />}
  ...
  return <main className="app-shell auth-shell">
    ...
    <section className="phone auth-phone" aria-label="ValX account preview">
      ...
      <div className="auth-content">
        <div className="auth-brand"><span>V</span><div><strong>ValX</strong></div></div>
